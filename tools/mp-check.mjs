...
const room = await beto.joinOrCreate('city', { token: 'beto', sceneId: 'central_plaza' });
...
await page.goto(`${BASE}&token=ana&name=Ana`, { waitUntil: 'networkidle', timeout: 60000 });
...
const betoPose = [...room.state.players.values()].find((p) => p.id === 'beto');
